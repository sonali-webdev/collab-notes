  ...
  return (
    <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4">
      <div className="bg-white rounded-3xl shadow-xl w-full max-w-md overflow-hidden">
        ...
        <div className="h-3 bg-coral-400" style={{ backgroundColor: "#FF6B6B" }} />

        <div className="p-8">
          <h1 className="text-4xl font-bold text-gray-900 mb-1">Login</h1>
          <p className="text-gray-400 text-sm mb-6">Welcome back! Please login to continue.</p>
          ...
          <p className="text-center text-gray-400 text-sm mt-6">
            ...
            <Link to="/register" className="font-bold text-gray-700 hover:underline">
              Sign Up
            </Link>
          </p>
        </div>
